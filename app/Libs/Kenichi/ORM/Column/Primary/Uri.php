...
class Uri extends Varchar
{
    protected bool $notnull = true;
      
    protected bool $unique = true;
    
    //add fromform => parse_seo_string
    public static function sanitize($string): string
    {
        return self::nice_uri(parent::sanitize($string));
    }
    
    public static function nice_uri(string $string): string
    {        
            ...
            return $friendlyurl = urlencode(strtolower(strtr($friendlyurl, $tbl)));
    }
